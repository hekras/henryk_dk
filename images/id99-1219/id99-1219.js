window.addEventListener('load', function() {
 ...
 //     console.log(dc)
      ...
      let tick = 0;
      var madeby = [
        new MadeBy("December 19th 2023",canvas.width + 600, 140),
      ];
      /*
      ...
      */
      ...
      var partiklerbg = [];
      var starCounter = 10;
      var gun = {x: canvas.width/2-50, y:canvas.height-50};
      var ycount = 0;
      var yspeed = 1;
      var xmax = 0;
      var xspeed = 5;
          ...
          case 2:
            ...
            if (xmax > canvas.height-80){
              state = 5;
                ...
                var color = 'rgb(' + r + ',' + g + ',' + b + ')';
                for(j=0;j<400;j++){
                  explosion.push(new ParticleEx(mouse.x - 30 + 60*Math.random(),canvas.height - 60 + 60*Math.random(), color));
                }
            }
            break;
          case 3:
