window.addEventListener('load', function() {
 ...
 //     console.log(dc)
      ...
      const madebytext = "Christmas, December 10th 2023";
      ...
      function animate() {
        ...
        for(i=0;i<explosion.length;i++){
          ...
          dc.fillStyle = "#000000";
          dc.fillText('....', radius1-20, canvas.height - 2*(50 + 100 + 150)+20);
          ...
          for(var a=0;a<6;a++){
            var x = radius1; 
            var y = yoff + a*65 ;//+ radius*Math.sin(6.22*tick/50 + a*3.14/3); 
            var gap = 15;
            dc.moveTo(x+gap,y)
            dc.arc(x, y, gap, 0, 6.28);
          }
