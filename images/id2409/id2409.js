window.addEventListener('load', function() {
  ...
  function animate() {
    ...
    for(var i=0; i<nnn; i++){
      ...
      dc.fillStyle = "beige";
      dc.fillText(wheel[i].id + ": " + wheel[i].text, dt*10 + draduis + 80, dline * wheel[i].id);
    }

    if (choice >= 0){
      dc.fillStyle = "pink";
      dc.fillText(wheel[choice].id + ": " + wheel[choice].text, dt*10 + draduis + 80, dline * wheel[choice].id);
    }
